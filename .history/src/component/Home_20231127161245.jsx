              ...
              <tbody key={index}>
                <tr className="border border-black ">
                  ...
                  <td className="border border-black p-2 underline text-blue-500">
                    ...
                    <Popup
                      trigger={<button className="button">N</button>}
                      modal
                      nested
                    >
                      {(close) => (
                        <div className="modal">
                          ...
                          <div className="content">
                            <div>
                              ...
                              >
                                <thead className="border-2 dark:border-white border-black">
                                    ...
                                    <td className="px-[20px] border-2 dark:border-white border-black">
                                      <table
                                        ...
                                        dangerouslySetInnerHTML={{
                                          __html: dataFromN?.name_g2_block,
                                        }}
                                      ></table>
                                    </td>
                                  ...
                                  <tr className="border-2 dark:border-white border-black">
                                    ...
                                    <td className="px-[20px] border-2 dark:border-white border-black">
                                      <table
                                        className="px-[20px] "
                                        dangerouslySetInnerHTML={{
                                          __html: dataFromN?.name_g3_block,
                                        }}
                                      ></table>
                                    </td>
