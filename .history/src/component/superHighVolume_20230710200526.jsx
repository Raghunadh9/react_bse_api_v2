...
const SuperHighVolume = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => setBseapisearchresponse(res.data.match(/\d+/g)));
    console.log(bseapisearchresponse);
  }, [searchStockName]);
  // const string = "This is a string with numbers 123 and 456.789";
  // const numbers = string.split(" ").filter((word) => !isNaN(parseFloat(word)));
