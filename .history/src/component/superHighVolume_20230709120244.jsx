...
const superHighVolume = () => {
  ...
  const [scrip_cd, setscrip_cd] = useState("");
  ...
  const submitHandler = (e) => {
    ...
    axios
      ...
      .then((res) => setName(res.data.Table[0].Name))
      .then((res) => setscrip_cd(res.data.Table[0].scrip_cd))
      .then((res) => setLTP(res.data.Table[0].LTP))
      .then((res) => setChange(res.data.Table[0].Change))
      .catch((err) => console.log(err));
    console.log([Name, scrip_cd, LTP, Change]);
  };
