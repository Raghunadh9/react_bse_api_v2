...
const SuperHighVolume = () => {
  ...
  const firstObject = bseData.length > 0 ? bseData[0] : null;
      ...
      <table>
        ...
        <tbody key={index + 1}>
          ...
          <tr className="border border-black p-2">
            <td> {index + 1}</td>
            <td className="border border-black p-2">{firstObject.Name}</td>
            <td className="border border-black p-2">{firstObject.LTP}</td>
            <td className="border border-black p-2">{firstObject.Change}</td>
            <td className="border border-black p-2">
              ...
              >
                <a
                  href={`https://in.tradingview.com/chart/qmDo3C1P/?symbol=BSE%3A${firstObject.Name}`}
                  target="_blank"
                ...
                <a
                  href={`https://in.tradingview.com/chart/VViXq6AO/?symbol=BSE%3A${firstObject.Name}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href={`https://in.tradingview.com/chart/1gQFO9Ge/?symbol=BSE%3A${firstObject.Name}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href={`https://in.tradingview.com/chart/3QIPa6zQ/?symbol=BSE%3A${firstObject.Name}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <td className="border border-black p-2">
              {" "}
              <a
                href={`https://www.google.com/search?q=moneycontrol+${firstObject.Name.split(
                  " - "
                )[0]
            ...
            <td className="border border-black p-2">
              <GetVolume scrip_cd={firstObject.scrip_cd} />
            </td>
            <td className="border border-black p-2">
              <GetDetailsComponent scrip_cd={firstObject.scrip_cd} />
              {/* {firstObject.scrip_cd} */}
            </td>
            <td>
              <button
                onClick={() => deleteHandler(firstObject.scrip_cd)}
                className="bg-purple-500 p-1 rounded-md text-white"
              >
                D
              </button>
