...
const SuperHighVolume = () => {
  ...
  useEffect(() => {
    ...
    onValue(starCountRef, (snapshot) => {
      ...
      const fetchDataBse = async () => {
        let requests = newPosts.map((fruit) =>
          axios.get(
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => setBseapisearchresponse(res.data.replace("")));
    console.log(bseapisearchresponse);
  }, [searchStockName]);
  const text =
    "<li class='quotemenu quotemenuselect'><a id='/stock-share-price/urja-global-ltd/urjagloba/526987/' href='/stock-share-price/urja-global-ltd/urjagloba/526987/'><strong>URJA</strong> GLOBAL LTD<br /><span><strong>URJA</strong>GLOBA&nbsp;&nbsp;&nbsp;INE550C01020&nbsp;&nbsp;&nbsp;526987</span> <span class='offleft' tabindex='-1' style='position: absolute; display:none; left: -999px;'>3 matches found </span></a></li><li class='quotemenu'><a id='/stock-share-price/urja-global-ltd/urja-re/750651/' href='/stock-share-price/urja-global-ltd/urja-re/750651/'><strong>URJA</strong> GLOBAL LTD<br /><span><strong>URJA</strong>-RE&nbsp;&nbsp;&nbsp;INE550C20012&nbsp;&nbsp;&nbsp;750651</span></li><li class='quotemenu'><a id='/stock-share-price/urja-global-ltd/urjapp/890152/' href='/stock-share-price/urja-global-ltd/urjapp/890152/'><strong>URJA</strong> GLOBAL LTD<br /><span><strong>URJA</strong>PP&nbsp;&nbsp;&nbsp;IN9550C01028&nbsp;&nbsp;&nbsp;890152</span></li>";

  const withoutLinks = text.replace(/<a\b[^>]*>(.*?)<\/a>/g, "");

  console.log("withoutLinks", withoutLinks);
  return (
    <div>
      <center>
