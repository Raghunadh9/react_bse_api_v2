...
const SuperHighVolume = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) =>
        setBseapisearchresponse(res.data.replace(/<a\b[^>]*>(.*?)<\/a>/g, "$1"))
      );
    console.log(bseapisearchresponse);
  }, [searchStockName]);
  // const text =
  //   "<a id='/stock-share-price/urja-global-ltd/urjagloba/526987/' href='/stock-share-price/urja-global-ltd/urjagloba/526987/'><strong>URJA</strong> GLOBAL LTD</a>";
